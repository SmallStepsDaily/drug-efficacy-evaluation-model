...
def js_divergence(control, drug):
    # 删除小于0.05的值
    ...
    # 计算JS散度
    js_divergence = jensenshannon(pdf_control, pdf_drug, base=2)  # base=2表示结果在[0, 1]之间
    ...
    plt.plot(x_range, pdf_drug, label='drug')
    plt.yticks([])  # 隐藏y轴刻度标签
...
if __name__ == '__main__':
    # 读取CSV文件
    data = pd.read_csv('../data/hql_20241021_2h_Ed_features.csv')  # 替换为你的CSV文件路径
